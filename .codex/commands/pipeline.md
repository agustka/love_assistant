...
1. Read `.codex/instructions/pipeline.manual.md` (the operating manual: startup steps, the work-type loops, decision rules, precedence rules, model-selection policy, output format) and `.codex/instructions/pipeline.reference.md`. Follow them as your own instructions.
