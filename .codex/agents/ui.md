...
- .codex/specs/layout.md (required)
- .codex/specs/bdd.md (required)
- .codex/handoff/application.handoff.md (required)
- .codex/handoff/review.handoff.md (optional — consumed during iterations when the review agent reports UI-layer violations)
- .codex/handoff/testing.handoff.md (optional — consumed during iterations when tests report UI behavior failures)
...
- If `testing.handoff.md` reports UI behavior failures → read diagnostic evidence (see `.codex/skills/test-diagnostics/SKILL.md`):
...
Produce `.codex/handoff/ui.handoff.md` with:
...
- `.codex/instructions/product-decision.md` — the product interaction doctrine (card-based model, four input shapes, prohibited chat cues). Consult it whenever a layout decision touches input surfaces or the shape of how output is presented.
