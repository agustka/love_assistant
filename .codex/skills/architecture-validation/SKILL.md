...
description: >-
  ...
  presentation conventions defined in the layer AGENTS.md files.
tools: []
---
...
- `AGENTS.md` files under `lib/application/`, `lib/domain/`, `lib/infrastructure/`, `lib/presentation/`, and `test/`
...
Source of truth lives in `AGENTS.md` per layer:

- `lib/application/AGENTS.md`
- `lib/domain/AGENTS.md`
- `lib/infrastructure/AGENTS.md`
- `lib/presentation/AGENTS.md`
- `test/AGENTS.md`
- Top-level `AGENTS.md` for Effective Dart conventions
...
For each new/modified symbol, confirm it belongs to the folder/layer responsibilities described in the AGENTS.md files. Flag violations such as:
...
Source: `lib/presentation/AGENTS.md` ("Every widget is a classified tier — no unclassified widgets next to pages").
...
- **violation** — change contradicts an explicit layer rule from a AGENTS.md file
