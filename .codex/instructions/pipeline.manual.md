...
See `.codex/instructions/iteration-flexibility.md` for the complete framework, including:
...
- **Iteration rules** (see `.codex/instructions/iteration-flexibility.md`):
