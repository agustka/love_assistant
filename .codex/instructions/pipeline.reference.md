...
1. **Handoff exists** — the expected `.codex/handoff/<agent>.handoff.md` file was created or updated
...
5. **No rogue artifacts** — no `.md`/`.txt` files were created outside `.codex/handoff/`
...
- enforce artifact discipline: agent coordination artifacts must live only in `.codex/handoff/`; reject standalone `.md`/`.txt` reports elsewhere
