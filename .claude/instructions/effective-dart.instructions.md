...
*   If a static-only class is used, it should not be instantiated and should not contain business logic.*   AVOID extending a class that isn't intended to be subclassed.
