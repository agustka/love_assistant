...
- Do not use `.claude/handoff/know-the-code.handoff.md` as implicit input for new investigations.
...
- Write `.claude/handoff/know-the-code.handoff.md` only when the caller explicitly requests handoff output.
...
If caller requests `handoff` output, write `.claude/handoff/know-the-code.handoff.md` using this structure:
