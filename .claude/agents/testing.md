...
- .claude/handoff/coordination.plan.md (required — provides `required_layers`, `work_type`, and `tdd_phase` to scope testing)
...
- .claude/handoff/testing.handoff.md
...
6. **Inter-agent communication only through** `.claude/handoff/*.handoff.md`.
7. **No standalone reports** outside `.claude/handoff/`.
...
Produce `.claude/handoff/testing.handoff.md` with:
