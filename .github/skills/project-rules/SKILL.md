...
2. `.github/instructions/effective-dart.instructions.md`
3. `.github/instructions/*-layer-rules.instructions.md`
4. `.github/instructions/presentation-and-atomic-design.instructions.md`
5. `.github/instructions/test-conventions.instructions.md`
...
From `.github/instructions/effective-dart.instructions.md`:
...
From `.github/instructions/*` and static rules:
...
From `.github/instructions/test-conventions.instructions.md`:
...
- `.github/instructions/effective-dart.instructions.md`
- quoting split rule:
...
Using `.github/instructions/*_layer_rules.instructions.md` and presentation rules:
...
Using `.github/instructions/test-conventions.instructions.md`:
...
- allowed/forbidden test-category paths from `.github/instructions/test-conventions.instructions.md`
