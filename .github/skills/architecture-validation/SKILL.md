...
- `.github/skills/know-the-code/SKILL.md`
...
- `.github/instructions/presentation-and-atomic-design.instructions.md`
- `.github/instructions/application-layer-rules.instructions.md`
- `.github/instructions/domain-layer-rules.instructions.md`
- `.github/instructions/infrastructure-layer-rules.instructions.md`
...
- **violation**
  - change contradicts declared layer rules in `.github/instructions/*_layer_rules.instructions.md`
