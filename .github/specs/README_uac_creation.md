...
Use `.github/specs/uac.yaml` to provide the UAC Creator agent with feature context and design reference.

---

## Purpose

`uac.yaml` supplies the UAC Creator with the information needed to generate comprehensive acceptance criteria. It feeds into the UAC Creator agent, which produces `.github/specs/bdd.md` (structure: Work Type, User Story, Acceptance Criteria) for downstream pipeline execution.
...
- The UAC Creator reads this file and produces `.github/specs/bdd.md`
- Do not edit `.github/specs/bdd.md` directly for new UACs; always use `uac.yaml` as input
