...
tools: ['search/codebase', 'search/fileSearch', 'search/listDirectory', 'search/textSearch', 'search/usages', 'search/searchResults', 'read/readFile', 'read/problems', 'show_content', 'open_file', 'list_dir', 'read_file', 'file_search', 'grep_search', 'get_errors', 'semantic_search', 'create_file', 'apply_patch', 'insert_edit_into_file']
---
...
- Only write `.github/handoff/know-the-code.handoff.md` when the caller explicitly asks for a handoff or the pipeline asks for a reusable artifact.
...
- `handoff` -> write `.github/handoff/know-the-code.handoff.md`.
...
When a handoff is explicitly requested, write `.github/handoff/know-the-code.handoff.md`.
