...
- When creating markdown files (.md), NEVER use terminal commands (heredoc, cat, echo). 
- Always use the `create_file` tool instead - terminal commands fail with markdown content containing YAML frontmatter, tables, or backticks.
