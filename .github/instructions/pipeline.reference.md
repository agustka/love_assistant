...
1. **Handoff exists** — the expected `.github/handoff/<agent>.handoff.md` file was created or updated
...
5. **No rogue artifacts** — no `.md`/`.txt` files were created outside `.github/handoff/`
...
- enforce artifact discipline: agent coordination artifacts must live only in `.github/handoff/`; reject standalone `.md`/`.txt` reports elsewhere
