...
- ALWAYS extend IsbCubit (no exceptions)
...
- Direct getIt<T>() is only acceptable for cross-cutting singletons (EventBus, Navigation, IPollAndDebounce, IShareProvider)
