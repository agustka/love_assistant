...
class LaEpicImageOrganism extends StatelessWidget {
  final String asset;
  ...
  Widget build(BuildContext context) {
    ...
    if (Accessibility.of(context).isInAccessibilityMode && hideInAccessibilityMode) {
      core = const LaSizedBoxAtom.shrink();
    }
  ...
  Widget _getImage(BuildContext context) {
    if (type == LaEpicImageType.animation) {
      ...
      return LaImageAtom(
        ...
        fallback: fallbackAsset == null ? null : LaImageAtom(imageLink: fallbackAsset!),
      );
    }
  }

  double _getSize(BuildContext context) {
    final double dimension = heightAsPercentageOfScreen == null
        ? MediaQuery.sizeOf(context).width
        : MediaQuery.sizeOf(context).height;
    final double fraction = heightAsPercentageOfScreen == null
        ? widthAsPercentageOfScreen
        : heightAsPercentageOfScreen!;
