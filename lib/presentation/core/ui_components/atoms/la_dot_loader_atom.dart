...
class LaDotLoaderAtom extends StatefulWidget {
  final Color? color;
  final double size;
  ...
  @override
  State createState() => _LaDotLoaderAtomState();
}

class _LaDotLoaderAtomState extends State<LaDotLoaderAtom> with SingleTickerProviderStateMixin {
    ...
    return widget.itemBuilder != null
        ...
        : DecoratedBox(
            decoration: BoxDecoration(
              color: widget.color ?? LaTheme.primary(),
